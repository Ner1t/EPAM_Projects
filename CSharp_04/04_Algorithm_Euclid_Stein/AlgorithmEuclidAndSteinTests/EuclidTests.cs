...
namespace AlgorithmEuclidAndSteinTests
{
    public class EuclidTests
    {
        ...
        public void TestProcessorLogic_FirstEqualsSecondEuclid_Success()
        {
            ...
            int expected = 4;
            int actual = AlgorithmEuclidAndStein.Euclid.CalculateGcd(mass[0], mass[1]);
        ...
        public void TestProcessorLogic_FirstGreaterSecond_Success()
        {
            ...
            var expected = 4;
            var actual = AlgorithmEuclidAndStein.Euclid.CalculateGcd(mass[0], mass[1]);
        ...
        public void TestProcessorLogic_InputBoundaryParameters_Failure()
        {
            ...
            var actualMin = AlgorithmEuclidAndStein.Euclid.CalculateGcd(massMin);
            var actualMax = AlgorithmEuclidAndStein.Euclid.CalculateGcd(massMax);
        ...
        public void TestProcessorLogic_AllNumbersEven_Success()
        {
            ...
            var actual = AlgorithmEuclidAndStein.Euclid.CalculateGcd(mass);
            var expected = 2;
        ...
        public void TestProcessorLogic_FirstFivePrimeNumbersWithoutOne_Success()
        {
            ...
            var actual = AlgorithmEuclidAndStein.Euclid.CalculateGcd(mass[0], mass[1], mass[2], mass[3], mass[4]);
            var expected = 1;
        ...
        public void TestProcessorLogic_ThreeNumbers_Success()
        {
            ...
            var actual = AlgorithmEuclidAndStein.Euclid.CalculateGcd(mass[0], mass[1], mass[2]);
            var expected = 1;
        ...
        public void TestProcessorLogic_FourNumbers_Success()
        {
            ...
            var actual = AlgorithmEuclidAndStein.Euclid.CalculateGcd(mass[0], mass[1], mass[2], mass[3]);
            var expected = 1;
